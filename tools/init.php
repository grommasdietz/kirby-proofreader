...
$defaults = [
    'slug'   => 'grommasdietz/kirby-proofreader',
    'title'  => 'Kirby Proofreader',
    'handle' => 'grommasdietz/proofreader',
];
...
function buildReplacements(array $old, array $new): array
{
    ...
    $map['GrommasDietz\\Proofreader\\Tests\\'] = $new['namespace'] . 'Tests\\';
    $map[escapeNamespace('GrommasDietz\\Proofreader\\Tests\\')] = escapeNamespace($new['namespace'] . 'Tests\\');
    ...
    $map['/kirby-proofreader'] = '/' . $new['package'];
    $map['kirby-proofreader.test'] = $new['package'] . '.test';
